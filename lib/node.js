  ...
  .spread(function (version, features) {
    ...
    .then(function (configPath) {
      return new Bluebird(function (resolve, reject) {
        ...
        // run the process
        if (version && parseInt(version.split('.')[0]) >= 7) {
...
Node.prototype.onLogMessage = function (stream, message) {
  ...
  // SIREN: added ES7 support
  var typeHttp = ['http', 'http_server', 'netty_4_http_server_transport', 'abstract_http_server_transport'].indexOf(msgObj.type) > -1
